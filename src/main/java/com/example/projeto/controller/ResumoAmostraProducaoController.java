...
@Controller
@RequestMapping("/resumo-amostra-producao")
public class ResumoAmostraProducaoController {

    private final FichaTecnicaService service;

    public ResumoAmostraProducaoController(FichaTecnicaService service) {
        this.service = service;
    }

    @GetMapping
    public String resumo(@RequestParam(required = false) String colecaoFiltro, Model model) {
        Map<String, Map<String, Map<String, Long>>> resumoCompleto = service.resumoStatusProducaoPorColecaoETipo();
        ...
        return "resumo-amostra-producao";
    }
}
